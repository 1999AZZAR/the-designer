# Design System: Swiss Archival (International Style)

## Overview
This directory contains a complete, reusable UI/UX design system based on the concept of **1950s Swiss Graphic Design (Muller-Brockmann).**. 
...
* **Color Palette:** Primary colors (Red, Blue, Yellow), Black, White
...
* Rigid grid system. Flush left, ragged right text. Extreme mathematical alignment. Large, bold numbers.

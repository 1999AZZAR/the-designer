...
## Overview
This directory contains a complete, reusable UI/UX design system based on the concept of **Top secret government espionage file.**. 
...
* **Color Palette:** Manila folder (#e4c59a), black typewriter ink, red stamp ink
...
* Interactive redacted black bars. Stamped rotational typography. Evidence photos taped to the document.

# Design System: 35mm Film Strip

## Overview
This directory contains a complete, reusable UI/UX design system based on the concept of **Physical camera film strip reel. Horizontally scrolling frames.**. 
...
* **Color Palette:** Black background, white text, orange/yellow film edge markings
...
* Uses CSS clip-paths or repeating radial gradients for film perforations. Photos are treated with heavy film grain and sepia/grayscale filters.
